...
variation, ntWindow=ntWindow, transcriptTable, gene2transcript)

## Or Using a predefined gene to transcript conversion table
...
The resulting information can be visualized using the function
...
```{r, eval=TRUE}
## Visualize impact of SNV on splice site strenghts and predicted SRE binding
